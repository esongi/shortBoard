...
<form id="writeForm" name="writeForm" method="post" action=""
	...
	<input type="hidden" name="bcode" value="${bcode}"> <input
		...
		name="key" value="${key}"> <input type="hidden" name="word"
		value="${word}"> <input type="hidden" name="ref"
		value="${article.ref}"> <input type="hidden" name="lev"
		value="${article.lev}"> <input type="hidden" name="step"
		value="${article.step}"> <input type="hidden" name="pseq"
		value="${article.seq}">
