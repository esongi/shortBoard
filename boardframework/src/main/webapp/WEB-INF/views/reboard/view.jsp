...
<c:if test="${article != null }">
		...
		<form name="bbsForm" id="bbsbbs" method="post">
			...
			<tr>
				...
				<label class="newpage">최신목록</label> <font color="#c5c5c5">|</font>
					<labe class="mvpage">목록</labe> <font color="#c5c5c5">|</font>
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		...
		<tr height="26">
			<td width="100%" style="padding-left: 14px"><font class="stext">글번호 :</font>
				<font class="text_commentnum">${article.seq}</font> &nbsp; <font
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr valign="top">
			...
			<td align="right" nowrap><label class="newpage">최신목록</label> <font color="#c5c5c5">|</font>
					<labe class="mvpage">목록</labe> <font color="#c5c5c5">|</font>
